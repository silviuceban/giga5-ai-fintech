    ...
    <VuiBox position="relative">
      ...
      >
        ...
        >
          ...
          >
            <VuiAvatar src={logo} alt="profile-image" variant="rounded" size="xl" shadow="sm" />
          </Grid>
          ...
          <Grid item xs={12} md={6} lg={6.5} xl={6} xxl={4} sx={{ ml: "auto" }}>
            <AppBar position="static">
              ...
              >
                ...
                <Tab label="HISTORY GOALS" icon={<IoDocument color="white" size="16px" />} />
                <Tab label="ADD GOAL" icon={<IoClipboardOutline color="white" size="16px" />} />
              </Tabs>
            </AppBar>
          </Grid>
        </Grid>
